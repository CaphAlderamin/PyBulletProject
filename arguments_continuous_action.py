...
def parse_args():
    ...
    parser.add_argument("--num-minibatches", type=int, default=40, # default=32
    ...
    parser.add_argument("--num-steps", type=int, default=128,  # default= 64, 128
                        help="the number of steps to run in each environment per policy rollout")
    parser.add_argument("--exp-name", type=str, default="ppo_continuous_action", 
                        help="the name of this experiment")
    # "HalfCheetahBulletEnv-v0" "KukaDiverseObjectGrasping-v0"
    ...
    # Logging
    parser.add_argument("--info", type=lambda x:bool(strtobool(x)), default=True, nargs="?", const=True,
                        help="if toggled, additional information will be printed")
    parser.add_argument("--info-camera", type=lambda x:bool(strtobool(x)), default=True, nargs="?", const=True,
